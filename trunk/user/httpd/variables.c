...
#include "common.h"
	...
	struct variable variables_LANHostConfig[] = {
			...
			{"zapretc.strategy1", "File", NULL, EVM_RESTART_ZAPRET|EVM_BLOCK_UNSAFE},
			{"zapretc.strategy2", "File", NULL, EVM_RESTART_ZAPRET|EVM_BLOCK_UNSAFE},
			{"zapretc.strategy3", "File", NULL, EVM_RESTART_ZAPRET|EVM_BLOCK_UNSAFE},
			{"zapretc.strategy4", "File", NULL, EVM_RESTART_ZAPRET|EVM_BLOCK_UNSAFE},
			{"zapretc.strategy5", "File", NULL, EVM_RESTART_ZAPRET|EVM_BLOCK_UNSAFE},
			{"zapretc.strategy6", "File", NULL, EVM_RESTART_ZAPRET|EVM_BLOCK_UNSAFE},
